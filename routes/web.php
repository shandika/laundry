...
// ====================================== Front-End ==============================================
Route::get('/', 'FrontEnd\HalDepanController@index')->name('depan');
Route::get('/registrasi', 'FrontEnd\HalDepanController@registrasi')->name('registrasi');
...
Route::post('/simpan_member', 'HalPelangganController@simpanMember');
// =================================================================================================
...
// => Halaman Pelanggan
	...
	Route::get('/kelola_transaksi_masuk', 'HalPelangganController@halamanTransaksiMasuk');
	...
	Route::get('/layanan_non_member/{id}', 'HalPelangganController@halamanLayananNonMember');
...
// => Halaman Laporan
	...
	Route::post('/edit_barang/{id}','HalInventoryController@editBarang');
	Route::get('/lihat_barang/{id}','HalInventoryController@lihatBarang');
	Route::get('/hapus_barang/{id}','HalInventoryController@hapusBarang');
	Route::get('/laporan_inventory','HalInventoryController@laporan');
});
// =================================================================================================
