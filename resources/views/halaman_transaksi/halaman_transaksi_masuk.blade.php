			...
			<div class="row">
                ...
                <div class="col-md-9" style="margin-top: -10px;">
                    <div class="d-flex justify-content-end">
                        <button class="btn btn-flat btn-primary" id="selesai-btn">Baru</button>
                        <button class="btn btn-flat btn-outline-primary ml-2" id="diantar-btn">Proses</button>
                        <button class="btn btn-flat btn-outline-primary ml-2" id="diambil-btn">Selesai</button>
                    </div>
                </div>
            </div>
		</div>
                        ...
                        <table class="table table-striped table-bordered zero-configuration">
                            ...
                            <tbody>
                            	...
                            	<tr>
                                    ...
                                    <a href="{{ url('/detail_pelanggan_member/' . $transaksi->id_pelanggan) }}" class="btn btn-sm btn-outline-primary btn-flat font-weight-bold">Lihat</a>
                                    </td>
                            	</tr>
                            	<?php $number1++ ?>
                            	@endif
                        ...
                        <table class="table table-striped table-bordered zero-configuration">
                            ...
                            <tbody>
                            	...
                            	<tr>
                            		...
                            		<td style="font-size: 16px;" class="text-center">
                            			<a href="{{ url('/detail_pelanggan_member/' . $transaksi->id_pelanggan) }}" class="btn btn-sm btn-outline-primary btn-flat font-weight-bold">Lihat</a></td>
                            	</tr>
                            	<?php $number4++ ?>
                            	@endif
                            	@endforeach
