			...
			<div class="card">
				<div class="card-body">
					<div class="d-flex justify-content-between">
						...
						<button type="button" class="btn font-weight-bold btn-sm mb-1 btn-primary" data-toggle="modal" data-target="#exampleModal">Tambah Pesanan <span class="btn-icon-right"><i class="fa fa-plus"></i></span></button>
					</div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
		...
		<a href="https://drive.google.com/drive/folders/17Qnkn51AacwXYzYPeA7ByJEp_q2e4nRH?usp=sharing" type="button" class="btn btn-success" target="_blank">Lihat Harga</a>
