    ...
    <div id="main-wrapper">
        <div class="nav-header">
            <div class="brand-logo">
                <a href="{{ url('/') }}">
                    <b class="logo-abbr"><img src="{{ asset('icons/logoclean.png') }}" alt=""> </b>
                    <span class="logo-compact"><p>CLEAN YOURS</p></span>
                    <span class="brand-title">
                        <p style="color: white; font-family: Times; font-size: 25px">CLEAN YOURS</p>
                    </span>
                </a>
            </div>
        </div>
            ...
            <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        ...
                        @php
                        $jml_pesanan = \App\Pesanan::where('status', '0')
    	                ->count();
                        $jml_baru = \App\Transaksi::where('status', 'baru')
    	                ->count();
                        $jml_selesai_cuci = \App\Transaksi::where('status', 'selesai')
    	                ->count();
                        @endphp
                        <ul aria-expanded="false">
                            <li><a href="{{ url('/registrasi_pelanggan') }}">Registrasi Pelanggan</a></li>
                            <li><a href="{{ url('/kelola_pelanggan') }}">Kelola Pelanggan</a></li>
                            <li><a href="{{ url('/pesanan_baru') }}">Pesanan Baru <span class="badge badge-info right">{{ $jml_pesanan }}</span></a></li>
                            <li><a href="{{ url('/kelola_transaksi_masuk') }}">Transaksi Masuk <span class="badge badge-info right">{{ $jml_baru }}</span></a></li>
                            <li><a href="{{ url('/kelola_transaksi') }}">Transaksi Keluar <span class="badge badge-info right">{{ $jml_selesai_cuci }}</span></a></li>
                        </ul>
                    </li>
                    @if(auth()->user()->role == 'admin')
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="{{ url('/laporan_inventory') }}">Laporan Inventory</a></li>
                        </ul>
                    </li>
                    @endif
