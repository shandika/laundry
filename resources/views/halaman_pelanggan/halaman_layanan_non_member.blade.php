                ...
                <div class="card-body">
                	<div class="row">
                		...
                		<div class="col-md-4 akun-pelanggan text-left">
                            ...
                            @else
                            <div class="btn btn-sm btn-danger font-weight-bold">Non Member</div>
                            @endif
	                	</div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="input-group">
                                                    ...
                                                    @if(date('j n', strtotime($pelanggans->tgl_lahir)) == Carbon\Carbon::now()->isoFormat('D M'))
                                                    <span style="color: red;">Pelanggan Ini Mendapatkan Diskon Karena Hari Ini Adalah Hari Ulang Tahunnya</span>
                                                    @else
                                                    @endif
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="input-group">
                                                    ...
                                                    @if(date('j n', strtotime($pelanggans->tgl_lahir)) == Carbon\Carbon::now()->isoFormat('D M'))
                                                    <span style="color: red;">Pelanggan Ini Mendapatkan Diskon Karena Hari Ini Adalah Hari Ulang Tahunnya</span>
                                                    <button class="btn btn-primary hitung-kilo">Hitung</button>
                                                    @else
                                                    @endif
                                                </div>
                                            </div>
...
$(document).on('click', '.hitung-kilo', function(){
    var sub_total = $('.total_kiloan_rp_input').val();
    var persen_diskon = 20;
    var diskon = sub_total * (persen_diskon / 100);
    var persen_pajak = $('.pajak_bayar_kilo').val();
    var pajak = sub_total * (persen_pajak / 100);
    var total = (sub_total - diskon) + pajak;
