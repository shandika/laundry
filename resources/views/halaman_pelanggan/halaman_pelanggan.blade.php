                        ...
                        <table class="table table-striped table-bordered zero-configuration">
                            ...
                            <tbody>
                            	...
                            	<tr>
                            		...
                            		<td>{{ $pelanggan->no_hp_pelanggan }}</td>
                            		<td style="font-size: 16px;" class="text-center">
                            			<a href="{{ url('/detail_pelanggan_non_member/' . $pelanggan->id) }}" class="btn btn-sm btn-outline-primary btn-flat font-weight-bold">Lihat</a>&nbsp;&nbsp;<a href="{{ url('/layanan_non_member/' . $pelanggan->id) }}" class="btn btn-sm btn-primary btn-flat font-weight-bold">Layanan</a></td>
