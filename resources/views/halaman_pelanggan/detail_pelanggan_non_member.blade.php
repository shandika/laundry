                ...
                <div class="card-body">
                    <div class="media align-items-center mb-4">
                        ...
                        <div class="media-body">
                            ...
                            <p style="color: green;" class="mb-0">Member</p>
                            @else
                            <p style="color: red;" class="mb-0">Non Member</p>
                            @endif
                    ...
                    <div class="row mt-3 mb-1">
						...
						@if($pelanggans->cek_member == "non_member" && $akun_pelanggans->role == "non_member")
						<div class="col-12 text-center mb-2">
							<form action="{{ url('/jadikan_member/'.$pelanggans->kd_pelanggan) }}" method="post">
								@csrf
							<button type="submit" class="btn btn-flat btn-success font-weight-bold"><i class="fa fa-vcard-o"></i>&nbsp;&nbsp;Jadikan Member</button>
							</form>
                        </div>
						@else
