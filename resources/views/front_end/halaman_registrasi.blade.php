...
<head>
  <meta charset="utf-8">
  <title>CLEAN YOURS: Sign up</title>
      ...
      <div class="box-root padding-top--24 flex-flex flex-direction--column" style="flex-grow: 1; z-index: 9;">
        ...
        <div class="formbg-outer">
          <div class="formbg">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ url('/simpan_member') }}" class="registrasi-form" method="POST">
                        @csrf
          ...
          <div class="footer-link padding-top--24">
            <span>Have an account? <a id="regis" href="{{ route('login') }}">Sign in</a></span>
