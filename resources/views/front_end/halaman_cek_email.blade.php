        ...
        <div class="formbg-outer">
          <div class="formbg">
            <div class="formbg-inner padding-horizontal--48">
              ...
              <span class="padding-bottom--15">Seems like you forgot your password. If this true, fill your email bellow to reset your password</span>
              <form method="POST" action="{{ url('/cek_email') }}" id="stripe-login" name="form_login">
                  @csrf
                ...
                If you still forgot your email or password, please contact us
                <a class="ssolink" href="mailto:cleanyours2022@gmail.com">cleanyours2022@gmail.com</a>
                </div>
              </form>
            </div>
          </div>
